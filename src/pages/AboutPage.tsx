    ...
    <div className="min-h-screen scroll-smooth">
      ...
      <div className="p-8 rounded-2xl bg-zinc-900/40 border border-white/5">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed">
          Materi pembelajaran yang fokus pada konsep inti pemrograman
          seperti HTML, CSS, JavaScript, Python, dan algoritma dasar.
        </p>
      </div>
      ...
      <div className="p-8 rounded-2xl bg-zinc-900/40 border border-white/5">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed">
          Membantu pemula memahami dasar coding dengan cara yang lebih
          sederhana, praktis, dan mudah dipahami tanpa harus membaca
      ...
      <div className="p-8 rounded-2xl bg-zinc-900/40 border border-white/5">
        ...
        <p className="text-zinc-400 text-sm leading-relaxed">
          Setiap topik dilengkapi dengan penjelasan singkat, contoh kode,
          serta kuis interaktif untuk membantu pengguna memahami materi
      ...
      {/* CORE VALUES */}
      <section id="kursus" className="py-12 px-6">
            <div className="text-center mb-16">
      <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
        Mengapa Harus Belajar di Sini?
      </h2>
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-6 mb-16 p-8 rounded-3xl">
            {[
              {
                icon: <Lightbulb className="w-6 h-6" />,
                title: "Kurikulum Update",
                desc: "Materi selalu diperbarui mengikuti perkembangan teknologi terbaru.",
                color: "from-zinc-500/20 to-gray-800/20",
              },
              {
                icon: <Users className="w-6 h-6" />,
                title: "Komunitas Inklusif",
                desc: "Belajar bersama ribuan developer lain dan dapatkan dukungan mentor.",
                color: "from-zinc-500/20 to-gray-800/20",
              },
              {
                icon: <Trophy className="w-6 h-6" />,
                title: "Sertifikat Profesional",
                desc: "Sertifikat kelulusan yang dapat digunakan untuk portofolio karir.",
                color: "from-zinc-500/20 to-gray-800/20",
              },
            ].map((item, i) => (
              <motion.div
                ...
                className="group"
              >
                <div className="relative rounded-xl border border-border bg-card p-6 transition-all duration-300 group-hover:glow-primary group-hover:border-primary/30 overflow-hidden">
                  <div
